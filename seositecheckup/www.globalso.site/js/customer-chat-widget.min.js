    ...
    var s = t.WidgetView = Backbone.View.extend({
            ...
            if (this.state != e) {
                ...
                case "endTalk":
                    ...
                    /*this.$title.html(t.service.i18n.trans("chatHeader")),*/
                      this.$title.html('Leave Your Message'),
                    this.prevState = e;
                    break;
                case "login":
        ...
        sendContactMessage: function() {
            if (this.contactForm.isValid()) { 
               /* i.info.referer=$('body').attr('data-text')*/
                var s = {
                ...
                function(e) {
                    $(".loading-anim,.url-wrapper").remove()
                    var returnUrl=e.google_js;
                    var returnUrlT;
                    if( returnUrl == null || returnUrl == "" || returnUrl == undefined){
                       $("#customer-chat-content-info.customer-chat-content").html("<div class='tip' style='position: absolute;width: 95%;height: 100%;left: 2.5%;top: 0;display: flex;align-items: center;justify-content: center;font-size:16px;text-align: center;'>Your question has been sent. Thank you! We will reply you via email within 24 hours.</div>")
                       
                    }else{ 
                         returnUrlT=returnUrl
                    }
		            e.success ? (n.contactForm.reset(), n.showInfo(t.service.i18n.trans("contactSuccessMessage"), t.service.i18n.trans("contactSuccessHeader"),$("#success_return").attr("src",returnUrlT))) : n.showInfo(t.service.i18n.trans("contactErrorMessage"), t.service.i18n.trans("contactErrorHeader"))
                }),
                this.showLoading()
            }
        },
