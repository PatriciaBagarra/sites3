...
;(function($){
    ...
    $.fn.fix = function(options){
        ...
        this.each(function(){			
			...
			var defaultTop = thisBox.offset().top;	//é»˜top	
...
var mySwiper = new Swiper('.liper-team', {
    slidesPerView: 5,
    spaceBetween: 30,
	autoplay: true, 
	 navigation: {
